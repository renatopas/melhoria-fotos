...
Respostas que alterem a proporção da página em mais de 10% são rejeitadas automaticamente. Isso evita salvar respostas em que o modelo tenha criado uma comparação, painel ou página adicional.
